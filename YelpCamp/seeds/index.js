...
const seedDB = async() =>{
    ...
    for(let i = 0; i < 200; i++){
        ...
        const camp = new Campground({
            ...
            images: [
                {
                  url: 'https://res.cloudinary.com/dxuhsqwy4/image/upload/v1714367261/YelpCamp/swing_werqtl.jpg',
                  filename: 'YelpCamp/swing_werqtl'
                },
                {
                  url: 'https://res.cloudinary.com/dxuhsqwy4/image/upload/v1714367351/YelpCamp/Tent_h5urwa.jpg',
                  filename: 'YelpCamp/Tent_h5urwa'
                }
              ],
